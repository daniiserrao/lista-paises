...
function handleCountryButtons(){
    const countryButtons = Array.from(tabCountries.querySelectorAll('.add'))
    const favoriteButtons = Array.from(tabFavorites.querySelectorAll('.rmv'))
